      ...
      >
        ...
        >
          ...
          <input
            ...
            className="w-full bg-white border border-gold/30 rounded-xl px-4 py-3 text-sm text-black"
          />
          ...
          <label className="flex items-center gap-3 border border-dashed border-gold/40 rounded-xl px-4 py-4 cursor-pointer">
          ...
          <button
            ...
            className="btn-gold rounded-xl py-3 w-full font-semibold"
          >
